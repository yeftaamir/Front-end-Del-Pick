  ...
  class Order {
    ...
    final String? notes;
    final bool hasGivenRating; // Add this property
    ...
    Order({
      ...
      this.tracking,
      this.notes,
      this.hasGivenRating = false, // Add default value
    });
    ...
    Order copyWith({
      ...
      Tracking? tracking,
      String? notes,
      bool? hasGivenRating, // Add this parameter
    }) {
      return Order(
        id: id ?? this.id,
        ...
        hasGivenRating: hasGivenRating ?? this.hasGivenRating, // Add this line
      );
    }
    ...
    factory Order.fromCart({
      ...
      return Order(
        ...
        hasGivenRating: false, // Add this line
      );
    }
